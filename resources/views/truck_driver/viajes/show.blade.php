            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">          
                        ...
                        <!-- Main modal -->
                        <div id="modalViajeNuevo" data-modal-backdrop="static" tabindex="-1" aria-hidden="true" class="mb-4 hidden fixed inset-0 z-50 overflow-y-auto modal-overflow-hidden">                            
