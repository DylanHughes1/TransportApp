                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 bg-white border-b border-gray-200">
                            ...
                            <form action="/truck_driver/viajes/image/{{$viaje->id}}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                @method('PUT')

                                <div class="flex flex-col items-center justify-center w-full space-y-6">
                                    <label class="block mb-4 text-lg font-medium text-gray-900 dark:text-white"
                                        for="default_size">Ingrese imagen del remito</label>

                                    <input name="image1"
                                        class="block w-full mb-5 text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                                        id="image1" type="file" accept=".png, .jpg" required>

                                    <input name="image2"
                                        class="block w-full mb-5 text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                                        id="image2" type="file" accept=".png, .jpg" capture="camera">

                                    <input name="image3"
                                        class="block w-full mb-5 text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                                        id="image3" type="file" accept=".png, .jpg">
                            ...
                            <div class="flex p-4 mb-4 text-sm text-yellow-800 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300"
                                ...
                                <div>
                                    En caso de necesitar subir mas imágenes, guarde las primeras
