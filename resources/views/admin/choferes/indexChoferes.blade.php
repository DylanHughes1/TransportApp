                                ...
                                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <div data-popover id="popover-B{{ $key }}" role="tooltip" class="absolute z-10 invisible inline-block text-sm text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 dark:text-gray-400 dark:border-gray-600 dark:bg-gray-800">
                                            <div class="px-3 py-2">
                                                <a href="#" data-modal-toggle="modalEliminar{{ $key }}" class="font-medium text-red-600 dark:text-red-500 hover:underline">Eliminar Chofer</a>
                                            </div>
                                            <div data-popper-arrow></div>
                                        </div>
                                                        ...
                                                        <form method="POST" action="/admin/truck-drivers/{{$truck_driver->id}}">
                                                            ...
                                                            <form class="max-w-sm mx-auto">
                                                                ...
                                                                <div class="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg shadow-sm space-y-2">
                                                                    <label class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Empresa</label>
                                                                    <div class="flex gap-4">
                                                                        <label for="don-mario" class="flex items-center text-sm text-gray-700 dark:text-gray-300">
                                                                            <input type="radio" name="company_name" value="Don Mario" class="mr-2 w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                                                            Don Mario
                                                                        </label>
                                                                        <label for="cereal-flet-sur" class="flex items-center text-sm text-gray-700 dark:text-gray-300">
                                                                            <input type="radio" name="company_name" value="Cereal Flet Sur" class="mr-2 w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                                                            Cereal Flet Sur
                                                                        </label>
                                                                    </div>
                                                                </div>

                                                                <button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" type="submit">Asignar</button>
                                                            </form>
