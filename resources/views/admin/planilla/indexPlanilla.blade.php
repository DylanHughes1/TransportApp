        ...
        <div class="flex items-top justify-center min-h-screen py-4">
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8"> 
                <div class="bg-white overflow-hidden shadow-md sm:rounded-lg p-8">
                    <h1 class="text-3xl font-bold text-gray-900 mb-8">Planilla Viajes</h1>
                    <div class="mb-6">
                    ...
                    <div class="flex justify-center">
                        <a href="planillaEmpresa"
                            class="block w-48 p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 transition-colors duration-300 ease-in-out">
                            <div class="flex flex-col items-center">
                                <svg class="w-14 h-14 mb-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <h5 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white text-center">Planilla de Empresa</h5>
                            </div>
                        </a>
                    </div>
                </div>
