@foreach ($viajes as $key => $viaje)                                   
    ...
    <!-- Main modal -->
    <div id="modalCombustible{{ $key }}" tabindex="-1" aria-hidden="true"
    ...
    <!-- Main modal -->
    <div id="modalRemito{{ $key }}" tabindex="-1" aria-hidden="true"
        class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative max-w-2xl max-h-full">
            <div class="relative max-w-2xl">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 space-y-6 text-justify text-lg font-medium text-gray-800">
                        ...
                        @else
                            <p class="text-gray-500">No hay imágenes asociadas</p>
                        @endif
                    </div>
                </div>
            </div>
