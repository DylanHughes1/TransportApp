                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                <tbody class="text-justify">
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                        ...
                                        <td class="px-2 py-3">
                                            <input type="number" name="hs_ext_km_recorrido" style="border: none; background-color: transparent; width: 125px; text-align: left;" class="py-1 text-sm" value="{{ $tabla1->hs_ext_km_recorrido }}">
                                        </td>
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                        ...
                                        <td class="px-2 py-3">
                                            <input type="number" name="hs_ext_km_recorrido_100" style="border: none; background-color: transparent; width: 125px; text-align: left;" class="py-1 text-sm" value="{{ $tabla1->hs_ext_km_recorrido_100 }}">
                                        </td>
                                        <td class="mr-6 py-3">
                                            {{$datos->hs_ext_km_recorrido}}
                                        </td>
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                        ...
                                        <td class="px-2 py-3">
                                            <input type="number" style="border: none; background-color: transparent; width: 125px; text-align: left;" class="py-1 text-sm" name="perm_f_res" value=" {{ $tabla1->perm_f_res }}" >
                                        </td>
                                        <td class="mr-6 py-3">
                                            {{$datos->perm_f_res}}
                                        </td>
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                        ...
                                        <td class="px-2 py-3">
                                            ...
                                            <input type="number" style="border: none; background-color: transparent; width: 125px; text-align: left;" class="py-1 text-sm" name="c_descarga" value="{{ $tabla1->c_descarga }}" >
                                        </td>
                                        <td class="mr-6 py-3">
                                            {{$datos->c_descarga}}
                                        </td>
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                        ...
                                        <td class="px-2 py-3">
                                            ...
                                            <input type="number" style="border: none; background-color: transparent; width: 125px; text-align: left;" class="py-1 text-sm" name="hs_50" value=" {{$tabla1->hs_50}}">
                                        </td>
                                        <td class="mr-6 py-3">
                                            {{$datos->hs_50}}
                                        </td>
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                        ...
                                        <td class="px-2 py-3">
                                            ...
                                            <input type="number" style="border: none; background-color: transparent; width: 125px; text-align: left;" class="py-1 text-sm" name="hs_100" value=" {{$tabla1->hs_100}}">
                                        </td>
                                        <td class="mr-6 py-3">
                                            {{$datos->hs_100}}
                                        </td>
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                        ...
                                        <td name="inasistencias_inj" class="mr-2 py-3">
                                            <input type="number" style="border: none; background-color: transparent; width: 125px; text-align: left;" class="py-1 text-sm" name="inasistencias_inj" value="{{$tabla1->inasistencias_inj}}">
                                        </td>
                                        <td class="columna-total px-6 py-3">
                                            @php
                            ...
                            <table class="w-full text-sm text-justify text-gray-500 dark:text-gray-400">
                                <tbody>
                                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                        ...
                                        <td class="w-20"></td> 
                                        <td class="px-4 py-3">
                                            <input type="number" style="border: none; background-color: transparent; width: 125px; text-align: left;" class="py-1 text-sm" name="antig" value="{{intval($tabla1->antig)}}">
                                        </td>
                                        <td class="subtotal1 py-3">
                                            @php
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                        ...
                                        <td class="subtotal1 px-6 py-3">
                                            <input type="number" style="border: none; background-color: transparent; width: 125px; text-align: left;" class="py-1 text-sm" name="antig" value="{{intval($tabla1->vacaciones)}}">
                                        </td>                                
                                    </tr>                             
                                </tbody>
                                <tfoot>
                                    ...
                                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                        ...
                                        <tbody>
                                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                                ...
                                                <td class="px-6 py-3">
                                                    <input  style="border: none; background-color: transparent; width: 125px; text-align: left;" class="py-1 text-sm" name="jubilacion" value=" {{floatval($tabla2->jubilacion)}}%">
                                                </td>
                                                <td class="px-6 py-3">
                                                    -
                                                </td>
                                            ...
                                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                                ...
                                                <td class="px-6 py-3">
                                                    <input  style="border: none; background-color: transparent; width: 125px; text-align: left;" class="py-1 text-sm" name="obra_social" value=" {{floatval($tabla2->obra_social)}}%">
                                                </td>
                                                <td class="px-6 py-3">
                                            ...
                                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                                ...
                                                <td class="px-6 py-3">
                                                    <input  style="border: none; background-color: transparent; width: 125px; text-align: left;" class="py-1 text-sm" name="cuota_solidaria" value=" {{floatval($tabla2->cuota_solidaria)}}%">
                                                </td>
                                                <td class="px-6 py-3">
                                            ...
                                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                                ...
                                                <td class="px-6 py-3">
                                                    <input  style="border: none; background-color: transparent; width: 125px; text-align: left;" class="py-1 text-sm" name="ley_19032" value=" {{floatval($tabla2->ley_19032)}}%">
                                                </td>
                                                <td class="px-6 py-3">
                                            ...
                                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                                ...
                                                <td class="px-6 py-3">
                                                    <input  style="border: none; background-color: transparent; width: 125px; text-align: left;" class="py-1 text-sm" name="seguro_sepelio" value=" {{floatval($tabla2->seguro_sepelio)}}%">
                                                </td>
                                                <td class="px-6 py-3">
                                            ...
                                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                                ...
                                                <td class="px-6 py-3">
                                                    <input  style="border: none; background-color: transparent; width: 125px; text-align: left;" class="py-1 text-sm" name="aju_apo_dto" value=" {{floatval($tabla2->aju_apo_dto)}}%">
                                                </td>
                                                <td class="px-6 py-3">
                                            ...
                                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                                ...
                                                <td class="px-6 py-3">
                                                    <input  style="border: none; background-color: transparent; width: 125px; text-align: left;" class="py-1 text-sm" name="asoc_mut_1nov" value=" {{floatval($tabla2->asoc_mut_1nov)}}%">
                                                </td>
                                                <td class="px-6 py-3">
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                <tbody class="text-justify">
                                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                        ...
                                        <td class="px-2 py-3">
                                            <input type="number" style="border: none; background-color: transparent; width: 125px; text-align: left;" class="py-1 text-sm" name="viatico_x_km" value="{{$tabla3->viatico_x_km}}">
                                        </td>
                                        <td class="mr-6 py-3">
                                            {{$datos->kms_rec}}
                                        </td>
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                        <th scope="row" class="px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            <input class="bg-white text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="cruce_frontera_name" value="{{$tabla3->cruce_frontera_name}}">
                                        </th>
                                        <td class="px-2 py-3">
                                            <input type="number" style="border: none; background-color: transparent; width: 125px; text-align: left;" class="py-1 text-sm" name="cruce_frontera" value="{{$tabla3->cruce_frontera}}">
                                        </td>
                                        <td class="mr-6 py-3">
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                        <th scope="row" class="px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            <input class="bg-white text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="comida_name" value="{{$tabla3->comida_name}}">
                                        </th>
                                        <td class="px-2 py-3">
                                            <input type="number" style="border: none; background-color: transparent; width: 125px; text-align: left;" class="py-1 text-sm" name="comida" value="{{$tabla3->comida}}">
                                        </td>
                                        <td class="mr-6 py-3">
                                            {{$datos->comida}}
                                        </td>
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                        <th scope="row" class="px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            <input class="bg-white text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="especial_name" value="{{$tabla3->especial_name}}">
                                        </th>
                                        <td class="px-2 py-3">
                                            <input type="number" style="border: none; background-color: transparent; width: 125px; text-align: left;" class="py-1 text-sm" name="especial" value="{{$tabla3->especial}}">
                                        </td>
                                        <td class="mr-6 py-3">
                                            {{$datos->especial}}
                                        </td>
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                        <th scope="row" class="px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            <input class="bg-white text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="pernoctada_name" value="{{$tabla3->pernoctada_name}}">
                                        </th>
                                        <td class="px-2 py-3">
                                            <input type="number" style="border: none; background-color: transparent; width: 125px; text-align: left;" class="py-1 text-sm" name="pernoctada" value="{{$tabla3->pernoctada}}">
                                        </td>
                                        <td class="mr-6 py-3">
                                            {{$datos->pernoctada}}
                                        </td>
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                        <th scope="row" class="px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            <input class="bg-white text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="permanencia_fuera_rec_name" value="{{$tabla3->permanencia_fuera_rec_name}}">
                                        </th>
                                        <td class="px-2 py-3">
                                            <input type="number" style="border: none; background-color: transparent; width: 125px; text-align: left;" class="py-1 text-sm" name="permanencia_fuera_rec" value="{{$tabla3->permanencia_fuera_rec}}">
                                        </td>
                                        <td class="mr-6 py-3">
                                            {{$datos->perm_f_res}}
                                        </td>
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                        <th scope="row" class="px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            <input class="bg-white text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="viatico_km_1_2_name" value="{{$tabla3->viatico_km_1_2_name}}">
                                        </th>
                                        <td class="px-2 py-3">
                                            <input type="number" style="border: none; background-color: transparent; width: 125px; text-align: left;" class="py-1 text-sm" name="viatico_km_1_2" value="{{$tabla3->viatico_km_1_2}}">
                                        </td>
                                        <td class="mr-6 py-3">
                                            {{$datos->km_1_2}}
                                        </td>
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                        <th scope="row" class="px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            <input class="bg-white text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="adicional_vacas_anuales_name" value="{{$tabla3->adicional_vacas_anuales_name}}">
                                        </th>
                                        <td class="px-2 py-3">
                                            <input type="number" style="border: none; background-color: transparent; width: 125px; text-align: left;" class="py-1 text-sm" name="adicional_vacas_anuales" value="{{$tabla3->adicional_vacas_anuales}}">
                                        </td>
                                        <td class="mr-6 py-3">
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                        <th scope="row" class="px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            <input class="bg-white text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="asignacion_no_remuner_name" value="{{($tabla3->asignacion_no_remuner_name)}}">
                                        </th>
                                        <td class="px-2 py-3">
                                            <input type="number" style="border: none; background-color: transparent; width: 125px; text-align: left;" class="py-1 text-sm" name="asignacion_no_remuner" value="{{($tabla3->asignacion_no_remuner)}}">
                                    ...
                                    @if(count($tabla3->nuevasFilas) > 0)
                                        ...
                                        <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                            <th scope="row" class="px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                <input class="bg-white text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="nombre{{$nuevaFila->id}}" value="{{$nuevaFila->nombre}}">
                                            </th>
                                            <td class="px-2 py-3">
                                                <input type="number" style="border: none; background-color: transparent; width: 125px; text-align: left;" class="py-1 text-sm" name="valor{{$nuevaFila->id}}" value="{{$nuevaFila->valor}}">                                             
                                            </td>
                                            <td class="px-6 py-3">
                                                -
                                            </td>
