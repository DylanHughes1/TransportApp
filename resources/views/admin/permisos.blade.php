        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
                ...
                <div class="bg-white shadow-md rounded-lg p-6">
                    ...
                    <form method="POST" action="/admin/update-subroles">
                        @csrf
                        @method('PUT')
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200 text-sm">
                                ...
                                <tbody class="divide-y divide-gray-100">
                                    @forelse($admins->sortBy('id') as $admin)
                                    <tr>
                                        <td class="px-4 py-2">{{ $admin->id }}</td>
                                        <td class="px-4 py-2">{{ $admin->name }}</td>
                                        <td class="px-4 py-2">
                                            <select name="subroles[{{ $admin->id }}]"
                        ...
                        <div class="pt-6 border-t flex justify-center">
                            <button type="submit"
                                class="inline-flex items-center px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white 
                       text-base font-semibold rounded-xl shadow-md transition-all focus:ring-4 focus:ring-blue-300">
                                Guardar todos
                            </button>
                        </div>
                    </form>
